...
from datacrew.crew import Datacrew
...
def train():
    ...
    try:
        Datacrew().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        Datacrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        Datacrew().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
